...
def wish():
    ...
    if h>=0 and h<12:
        voice("Good Morning Hari Krishna,i am your Assistant,how can i help you")
    elif h>=12 and h<18:
        voice("Good after noon Hari Krishna,i am your Assistant,how can i help you")
    else:
        voice("Good evining Hari Krishna,i am your Assistant,how can i help you")
